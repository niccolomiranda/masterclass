const PARAMS = {
  uProgress: { value: 0.5 },
  uColor: 0xffcf79,
  uBaseNoiseIteration: { value: 5 },
  uNoiseDiffusion: { value: 0.76 },
  uNoisePrecision: { value: 2.61 },
  uLightningDiffusion: { value: 0.01 },
  uLightningThickness: { value: 0.79 },
  uLightningPower: { value: 0.07 },
    ...
    this.material = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
            ...
            void main() {
              ...
              float pX = 0.5 -  pos.x / .9; // .9 = size (by default 1.0)
